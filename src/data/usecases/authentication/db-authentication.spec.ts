...
const makeUpdateAccessTokeRepository = (): UpdateAccessTokenRepository => {
...
const makeSut = (): SutTypes => {
	...
	const updateAccessTokenRepositoryStub = makeUpdateAccessTokeRepository()
...
describe('DbAuthentication UseCase', () => {
	...
	test('Should returns accessToken from TokenGenerator', async () => {
		const { sut } = makeSut()
